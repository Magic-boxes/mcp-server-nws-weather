    ...
    async def process_query(self, query: str) -> str:
        ...
        available_tools = [{
            ...
            "function": {
                ...
                # "input_schema": tool.inputSchema, # 这个是anthropic格式
                "parameters": tool.inputSchema, # 这个是openai的格式
            }
        ...
        for choice in assistant_message_content:
            if choice.finish_reason == 'tool_calls':
                print("开始调用函数：", choice.message.tool_calls)
                ...
                final_text.append(choice.message.content)
                print("返回的不是工具调用：", choice.message.content)
